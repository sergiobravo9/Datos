...
#define TM_1_8_TC_129_X_INCORRECT_PARAMS		13
...
void PUSService1::BuildTM_1_8_TC_129_X_IncorrectParams(CDTCHandler &tcHandler,
		CDTMList &tmList) {
	...
	tmHandler.SetUInt16AppDataField(tcHandler.GetPacketID());
	tmHandler.SetUInt16AppDataField(tcHandler.GetPackSeqCtrl());
	tmHandler.SetUInt8AppDataField(TM_1_8_TC_129_X_INCORRECT_PARAMS);
