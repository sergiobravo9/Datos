...
void PUSService129::ExecTC(CDTCHandler &tcHandler, CDTMList &tmList) {
	...
	case (1):
		...
		Exec129_1TC(tc_handler, tm_list);

		break;

	case (2):

		Exec129_2TC(tc_handler, tm_list);
...
void PUSService129::Exec129_1TC(CDTCHandler &tcHandler, CDTMList &tmList) {
	...
	CVx = tcHandler.GetNextUInt32();
	CVy = tcHandler.GetNextUInt32();

	PUSService129::sCVx = CVx;
	PUSService129::sCVy = CVy;
...
void PUSService129::Exec129_2TC(CDTCHandler &tcHandler, CDTMList &tmList) {
	...
	KpX = tcHandler.GetNextUInt32();
	KpY = tcHandler.GetNextUInt32();

	PUSService129::sCVx = KpX;
	PUSService129::sCVy = KpY;
